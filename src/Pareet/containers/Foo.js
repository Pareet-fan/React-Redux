...
export default class Foo extends Component{
    ...
    render(){
        ...
        return (
            <div className="j-foo">
                <input type="text" ref="myInput" className="fooText" onKeyUp={ this.handleKeyUp.bind(this)} placeholder="请输入信息回车或添加按钮确认"/>
                <button onClick={ this.handleClick.bind(this) } className="myBtn">添加</button>
                <dl className="nav-dl">
                    {
